...
--
-- Host: localhost    Database: adminSucursales
-- ------------------------------------------------------
...
--
-- Current Database: `adminSucursales`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `adminSucursales` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `adminSucursales`;

--
-- Table structure for table `idConstructor`
--

DROP TABLE IF EXISTS `idConstructor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `idConstructor` (
  `number` int(6) unsigned zerofill NOT NULL,
  `base` char(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `idConstructor`
--
...
INSERT INTO `sucursales` VALUES (000001,'apatzingan'),(000002,'morelia');
...
--
-- Current Database: `morelia`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `morelia` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
LOCK TABLES `clientes` WRITE;
/*!40000 ALTER TABLE `clientes` DISABLE KEYS */;
INSERT INTO `clientes` VALUES ('MOR000001','Jacinta','Moreno','Martin','MOMJ990930TH1'),('MOR000002','Camilo Pablo','Arriaga','Vázquez','ARVC910518ASD'),('MOR000003','Gustavo','Fernández','Quiroga','FEQG890726AS7'),('MOR000004','Miranda','Posadas','Castellanos','POCM741111QGH');
/*!40000 ALTER TABLE `clientes` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `direcciones` WRITE;
/*!40000 ALTER TABLE `direcciones` DISABLE KEYS */;
INSERT INTO `direcciones` VALUES ('MOR000001',000001,'Cuatla',123,'Felicitas del Río','Michoacán','58040');
/*!40000 ALTER TABLE `direcciones` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-12-04 19:33:57
